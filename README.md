...
[![Phalcon CI](https://github.com/SidRoberts/phalcon/actions/workflows/continuous-integration.yml/badge.svg?branch=refactor)](https://github.com/SidRoberts/phalcon/actions/workflows/continuous-integration.yml)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=SidRoberts_phalcon&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=SidRoberts_phalcon)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=SidRoberts_phalcon&metric=coverage)](https://sonarcloud.io/summary/new_code?id=SidRoberts_phalcon)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=SidRoberts_phalcon&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=SidRoberts_phalcon)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=SidRoberts_phalcon&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=SidRoberts_phalcon)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=SidRoberts_phalcon&metric=bugs)](https://sonarcloud.io/summary/new_code?id=SidRoberts_phalcon)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=SidRoberts_phalcon&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=SidRoberts_phalcon)
