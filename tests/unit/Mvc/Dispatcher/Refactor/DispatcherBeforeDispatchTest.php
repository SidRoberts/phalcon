...
class DispatcherBeforeDispatchTest extends BaseDispatcher
{
     ...
     * @since  2017-10-07
     */
    public function testBeforeDispatchForwardOnce(): void
    {
        $forwarded  = false;
     ...
     * @since  2017-10-07
     */
    public function testBeforeDispatchReturnFalse(): void
    {
        $dispatcher         = $this->getDispatcher();
     ...
     * @since  2017-10-07
     */
    public function testBeforeDispatchWithBeforeExceptionBubble(): void
    {
        $dispatcher         = $this->getDispatcher();
        $dispatcherListener = $this->getDispatcherListener();
     ...
     * @since  2017-10-07
     */
    public function testBeforeDispatchWithBeforeExceptionForwardOnce(): void
    {
        $forwarded          = false;
        $dispatcher         = $this->getDispatcher();
        $dispatcherListener = $this->getDispatcherListener();
     ...
     * @since  2017-10-07
     */
    public function testBeforeDispatchWithBeforeExceptionReturningFalse(): void
    {
        $dispatcher = $this->getDispatcher();
